...
"classList"in document.createElement("_")&&(!document.createElementNS||"classList"in document.createElementNS("http://www.w3.org/2000/svg","g"))?!function(){"use strict";var t=document.createElement("_");if(t.classList.add("c1","c2"),!t.classList.contains("c2")){var e=function(t){var e=DOMTokenList.prototype[t];DOMTokenList.prototype[t]=function(t){for(var n=0,i=arguments.length;n<i;n++)t=arguments[n],e.call(this,t)}};e("add"),e("remove")}if(t.classList.toggle("c3",!1),t.classList.contains("c3")){var n=DOMTokenList.prototype.toggle;DOMTokenList.prototype.toggle=function(t,e){return 1 in arguments&&!this.contains(t)==!e?e:n.call(this,t)}}t=null}():!function(t){"use strict";if("Element"in t){var e="classList",n="prototype",i=t.Element[n],s=Object,r=String[n].trim||function(){return this.replace(/^\s+|\s+$/g,"")},o=Array[n].indexOf||function(t){for(var e=0,n=this.length;e<n;e++)if(e in this&&this[e]===t)return e;return-1},a=function(t,e){this.name=t,this.code=DOMException[t],this.message=e},c=function(t,e){if(""===e)throw new a("SYNTAX_ERR","An invalid or illegal string was specified");if(/\s/.test(e))throw new a("INVALID_CHARACTER_ERR","String contains an invalid character");return o.call(t,e)},l=function(t){for(var e=r.call(t.getAttribute("class")||""),n=e?e.split(/\s+/):[],i=0,s=n.length;i<s;i++)this.push(n[i]);this._updateClassName=function(){t.setAttribute("class",this.toString())}},u=l[n]=[],h=function(){return new l(this)};if(a[n]=Error[n],u.item=function(t){return this[t]||null},u.contains=function(t){return t+="",c(this,t)!==-1},u.add=function(){var t,e=arguments,n=0,i=e.length,s=!1;do t=e[n]+"",c(this,t)===-1&&(this.push(t),s=!0);while(++n<i);s&&this._updateClassName()},u.remove=function(){var t,e,n=arguments,i=0,s=n.length,r=!1;do for(t=n[i]+"",e=c(this,t);e!==-1;)this.splice(e,1),r=!0,e=c(this,t);while(++i<s);r&&this._updateClassName()},u.toggle=function(t,e){t+="";var n=this.contains(t),i=n?e!==!0&&"remove":e!==!1&&"add";return i&&this[i](t),e===!0||e===!1?e:!n},u.toString=function(){return this.join(" ")},s.defineProperty){var f={get:h,enumerable:!0,configurable:!0};try{s.defineProperty(i,e,f)}catch(d){d.number===-2146823252&&(f.enumerable=!1,s.defineProperty(i,e,f))}}else s[n].__defineGetter__&&i.__defineGetter__(e,h)}}(self);
!function(t){"use strict";function e(e,i){var n;if(1==e?(n=t(".section-welcome h1, .section-welcome p"),requestAnimationFrame(function(){n.removeClass("animated pulse"),requestAnimationFrame(function(){n.addClass("animated pulse")})})):2==e?(n=t(".section-intro .container, .section-intro .pendulum"),requestAnimationFrame(function(){n.removeClass("transparent"),requestAnimationFrame(function(){n.addClass("animated flipInY")})})):5==e&&(n=document.querySelector(".section-joinus .joinus-wrapper"),requestAnimationFrame(function(){n.classList.remove("animated","tada"),requestAnimationFrame(function(){n.classList.add("animated","tada")})})),5!=e){var s=document.getElementsByClassName("glissade")[0];s.classList.add("pause","invisible"),requestAnimationFrame(function(){s.classList.remove("animate","pause","invisible","infinite","sepcial"),requestAnimationFrame(function(){s.classList.add("animate"),4==e&&s.classList.add("infinite","sepcial")},17)},17)}else requestAnimationFrame(function(){document.getElementsByClassName("glissade")[0].classList.remove("animate","pause","invisible","infinite","sepcial")});if(2==i){var a=t(".section-intro .container, .section-intro .pendulum");requestAnimationFrame(function(){a.removeClass("animated flipInY"),requestAnimationFrame(function(){a.addClass("transparent")},17)},17)}}!function(){for(var t=0,e=["ms","moz","webkit","o"],i=0;i<e.length&&!window.requestAnimationFrame;++i)window.requestAnimationFrame=window[e[i]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[e[i]+"CancelAnimationFrame"]||window[e[i]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(e,i){var n=(new Date).getTime(),s=Math.max(0,16-(n-t)),a=window.setTimeout(function(){e(n+s)},s);return t=n+s,a}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(t){clearTimeout(t)}),window.requestIdleCallback||(window.requestIdleCallback=function(t){requestAnimationFrame(t)})}();var i=function(e,i){if(this.width=300,this.height=300,this.radius=134,this.strokeWidth=4,this.strokeColor="#fff91a",this.dashArray=[10],this.dashOffset=0,this.degreeBegin=180,this.degreeEnd=220,this.dashDelta=-1.35,this.degreeDelta=.32,this.rocketWidth=80,this.rocketHeight=80,this.rocketScale=.5,this.rocketX=-this.radius-this.rocketWidth*this.rocketScale/2,this.rocketY=(-30-this.rocketHeight/2)*this.rocketScale,this.canvas=t(e)[0],this.ctx=this.canvas.getContext("2d"),this.rocketImg=t(i)[0],this.centerX=this.width/2,this.centerY=this.height/2,this.angle={},this.angle.begin=this.degreeBegin/180*Math.PI,this.angle.end=this.degreeEnd/180*Math.PI,this.angle.delta=this.degreeDelta/180*Math.PI,this.angle.init=this.angle.begin,this.animate=this._animate.bind(this),this.paused=!0,!this.canvas||!this.rocketImg)return!1;var n=this;return this.ctx.setLineDash||("mozDash"in this.ctx?this.ctx.setLineDash=function(t){n.ctx.mozDash=t}:"webkitLineDash"in this.ctx?this.ctx.setLineDash=function(t){n.ctx.webkitLineDash=t}:this.ctx.setLineDash=function(t){}),this};i.prototype.clear=function(){this.ctx.clearRect(0,0,this.width,this.height)},i.prototype.drawRocket=function(){this.ctx.save(),this.ctx.translate(this.centerX,this.centerY),this.ctx.rotate(this.angle.begin-this.angle.init),this.ctx.drawImage(this.rocketImg,this.rocketX,this.rocketY,this.rocketScale*this.rocketWidth,this.rocketScale*this.rocketHeight),this.ctx.restore()},i.prototype.drawOrbit=function(){this.ctx.save(),this.ctx.lineWidth=this.strokeWidth,this.ctx.strokeStyle=this.strokeColor,this.ctx.lineDashOffset=this.dashOffset,this.ctx.setLineDash(this.dashArray),this.ctx.beginPath(),this.ctx.arc(this.centerX,this.centerY,this.radius,this.angle.begin,this.angle.end,1),this.ctx.stroke(),this.ctx.restore()},i.prototype.render=function(){this.clear(),this.drawOrbit(),this.drawRocket()},i.prototype.pause=function(){this.paused=!0},i.prototype.play=function(){this.paused=!1,this._animate()},i.prototype._animate=function(){this.render(),this.dashOffset+=this.dashDelta,this.angle.begin=(this.angle.begin+this.angle.delta)%(2*Math.PI),this.angle.end=(this.angle.end+this.angle.delta)%(2*Math.PI),this.paused||requestIdleCallback(this.animate)},i.prototype.animate=function(){};var n=new i("canvas","img.rocket");n&&n.render(),t(document).ready(function(){t("#fullpage").fullpage({lockAnchors:!0,recordHistory:!1,anchors:["welcome","intro","planet","dept","joinus"],slidesNavigation:!0,afterRender:function(){setTimeout(function(){e(1)},500),t(".anonymous-monster-wrapper").css("bottom",t(window).width()/1080*181+"px");var i=t(".section-dept .fp-slidesNav");i.css("margin-left","-"+i.width()/2+"px"),t("#Map").on("touchstart","area",function(e){e.preventDefault();var i=this.getAttribute("href").substr(1).split("/");t.fn.fullpage.moveTo(i[0],i[1])})},onLeave:function(t,i,s){3==i?n.play():n.pause(),e(i,t)}}),/iwut/i.test(navigator.userAgent)&&"undefined"!=typeof token&&token.loadUrl&&t(".section-joinus .joinus")[0].addEventListener("touchstart",function(t){t.preventDefault(),token.loadUrl("http://token.team/join/Login/iwut")},!1)})}(jQuery);