...
(function(t){"use strict";function e(e){var i=t(e).find(".bubble").addClass("bubble-sticky");setTimeout(function(){i.removeClass("bubble-sticky")},4500)}function i(t,e,i,s){var n=t>i?i/t:1,a=e>s?s/e:1;return a>n?n:a}function s(){var e=t(window).width(),s=t(window).height();t(".section").each(function(){var n=t(this).data("section-width")||t(this).find("> .fp-tableCell").css("zoom",1).width(),a=t(this).data("section-height")||t(this).find("> .fp-tableCell").css("zoom",1).height();a&&t(this).find("> .fp-tableCell").css("zoom",i(n,a,e,s))}),t(".section .slide").each(function(){var n=t(this).data("section-height")||t(this).find("> .fp-tableCell").css("zoom",1)[0].scrollHeight;n&&t(this).find("> .fp-tableCell").css("zoom",i(980,n,e,s))})}var n=window.navigator.userAgent.match(/Trident|MSIE/);n&&t("map").on("focus","area",function(){this.blur()}),t(".bubble-fallback-container").removeClass("hidden"),t("map").on("mouseover touchmove","area",function(){var e=t(this).data("dept");t(".bubble-fallback-container ."+e).addClass("bubble-active")}),t("map").on("mouseout touchleave","area",function(){var e=t(this).data("dept");t(".bubble-fallback-container ."+e).removeClass("bubble-active")}),e(".bubble-fallback-container"),function(){for(var t=0,e=["ms","moz","webkit","o"],i=0;i<e.length&&!window.requestAnimationFrame;++i)window.requestAnimationFrame=window[e[i]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[e[i]+"CancelAnimationFrame"]||window[e[i]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(e,i){var s=(new Date).getTime(),n=Math.max(0,16-(s-t)),a=window.setTimeout(function(){e(s+n)},n);return t=s+n,a}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(t){clearTimeout(t)}),window.requestIdleCallback||(window.requestIdleCallback=function(t){requestAnimationFrame(t)})}();var a=function(e,i){if(this.width=570,this.height=570,this.radius=258,this.strokeWidth=4,this.strokeColor="#fff91a",this.dashArray=[10],this.dashOffset=0,this.degreeBegin=180,this.degreeEnd=220,this.dashDelta=-1.35,this.degreeDelta=.24,this.rocketWidth=80,this.rocketHeight=80,this.rocketX=-this.radius-this.rocketWidth/2,this.rocketY=-30-this.rocketHeight/2,this.canvas=t(e)[0],this.ctx=this.canvas.getContext("2d"),this.rocketImg=t(i)[0],this.centerX=this.width/2,this.centerY=this.height/2,this.angle={},this.angle.begin=this.degreeBegin/180*Math.PI,this.angle.end=this.degreeEnd/180*Math.PI,this.angle.delta=this.degreeDelta/180*Math.PI,this.angle.init=this.angle.begin,this.animate=t.proxy(this._animate,this),this.paused=!1,!this.canvas||!this.rocketImg)return!1;var s=this;return this.ctx.setLineDash||("mozDash"in this.ctx?this.ctx.setLineDash=function(t){s.ctx.mozDash=t}:"webkitLineDash"in this.ctx?this.ctx.setLineDash=function(t){s.ctx.webkitLineDash=t}:this.ctx.setLineDash=function(t){}),this};a.prototype.clear=function(){this.ctx.clearRect(0,0,this.width,this.height)},a.prototype.drawRocket=function(){this.ctx.save(),this.ctx.translate(this.centerX,this.centerY),this.ctx.rotate(this.angle.begin-this.angle.init),this.ctx.drawImage(this.rocketImg,this.rocketX,this.rocketY),this.ctx.restore()},a.prototype.drawOrbit=function(){this.ctx.save(),this.ctx.lineWidth=this.strokeWidth,this.ctx.strokeStyle=this.strokeColor,this.ctx.lineDashOffset=this.dashOffset,this.ctx.setLineDash(this.dashArray),this.ctx.beginPath(),this.ctx.arc(this.centerX,this.centerY,this.radius,this.angle.begin,this.angle.end,1),this.ctx.stroke(),this.ctx.restore()},a.prototype.render=function(){this.clear(),this.drawOrbit(),this.drawRocket()},a.prototype.pause=function(){this.paused=!0},a.prototype.play=function(){this.paused=!1,this._animate()},a.prototype._animate=function(){this.render(),this.dashOffset+=this.dashDelta,this.angle.begin=(this.angle.begin+this.angle.delta)%(2*Math.PI),this.angle.end=(this.angle.end+this.angle.delta)%(2*Math.PI),this.paused||requestIdleCallback(this.animate)},a.prototype.animate=function(){};var h=new a("canvas","img.rocket");h&&(h.render(),t(document).ready(function(){h.animate()})),t(document).ready(function(){t("#fullpage").fullpage({lockAnchors:!1,anchors:["main","dept"],onLeave:function(t,e,i){1==e?h.play():h.pause()},afterResize:function(){s()}}),t(window).resize()})}).call(this,jQuery);